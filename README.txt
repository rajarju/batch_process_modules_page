...
Modules Form Batch Process modules submits the Drupal's Module form as a Batch Process.
...
modules page.  Once enabled it will take up all submissions to the Modules form and run them as a batch process
